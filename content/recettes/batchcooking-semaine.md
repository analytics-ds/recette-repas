...
date: 2026-05-23
lastmod: 2026-05-23
seo_title: "Batchcooking semaine : guide complet et menu type"
h1: "Batchcooking semaine : préparer 5 jours de repas en 2h"
...
howto_name: "Batchcooking pour la semaine : 5 dîners en 2h"
howto_description: "Préparer cinq dîners pour la semaine en une seule session de deux heures le dimanche, avec liste de courses, déroulé minuté et conservation."
howto_total_time: "PT2H"
howto_steps:
  - name: "Construire le menu de la semaine"
    text: "Lister cinq dîners équilibrés en alternant viandes, poissons et plats végétariens. Privilégier des plats qui se réchauffent bien (mijotés, gratins, quiches) et garder une recette express pour le vendredi."
  - name: "Préparer la liste de courses"
    text: "Détailler tous les ingrédients nécessaires pour les cinq dîners, regrouper par rayon (légumes, protéines, féculents, produits laitiers) pour optimiser le passage en magasin."
  - name: "Préchauffer le four et faire la mise en place"
    text: "Préchauffer à 180°C. Sortir tous les ingrédients, laver et découper les légumes, mesurer les quantités. Cette étape de mise en place fait gagner 20 minutes sur le déroulé global."
  - name: "Lancer la cuisson en parallèle"
    text: "Poulet rôti au four pendant 1h, pâtes complètes et riz dans deux casseroles, légumes rôtis sur la même plaque que le poulet pour ne préchauffer qu'une fois."
  - name: "Assembler et cuire la quiche"
    text: "Préparer la pâte à quiche, garnir avec courgettes et fromage de chèvre, enfourner 35 minutes pendant que les autres préparations finissent."
  - name: "Préparer les sauces et le curry"
    text: "Pendant la cuisson de la quiche, préparer le curry de pois chiches aux épinards et les sauces d'assaisonnement (vinaigrette, sauce soja-gingembre) pour la semaine."
  - name: "Refroidir et conditionner"
    text: "Laisser refroidir complètement chaque préparation, répartir en contenants en verre hermétiques, étiqueter avec la date et ranger au frigo par ordre chronologique de consommation."
faq:
  - q: "Combien de temps prévoir pour un batchcooking semaine ?"
    a: "Comptez deux à trois heures le dimanche pour cuisiner les bases de cinq dîners. Avec un peu d'organisation, vous pouvez tomber à 1h30 quand vous maîtrisez votre déroulé. La règle d'or : tout préparer en parallèle, four et plaque en simultané, mise en place complète avant d'allumer le feu."
  - q: "Combien de jours peut-on conserver les plats préparés ?"
    a: "Au frigo, trois à quatre jours maximum dans des contenants hermétiques en verre. Pour les jours 4 et 5 de la semaine, mieux vaut prévoir une recette plus rapide à assembler le jour même (salade composée, pâtes express). On peut aussi congeler des portions pour décaler à la semaine suivante."
  - q: "Faut-il un matériel particulier pour le batchcooking ?"
    a: "Le strict nécessaire : six à huit contenants en verre avec couvercles hermétiques (taille variée), une grande cocotte, une plaque de four, un bon couteau, une balance. Optionnel mais utile : un robot multifonction comme un Thermomix ou un Cookeo qui permet de cuire plusieurs préparations sans surveillance."
  - q: "Comment éviter de manger la même chose toute la semaine ?"
...
Pour ce menu type, voici la liste de courses pour quatre personnes :

- Protéines : un poulet entier (1,2 kg), un paquet de lardons fumés, une boîte de pois chiches (400 g), 200 g de pâtes carbonara.
- Légumes : 500 g de courgettes, 1 potimarron, 1 sachet d'épinards frais, 4 tomates, 1 salade verte, 4 oignons, 4 gousses d'ail, 1 sachet de pois mange-tout.
...
Une fois tout cuit et refroidi, on répartit dans des contenants en verre adaptés. Le poulet désossé se conserve trois jours au frigo, parfait pour les dîners de lundi et mardi. Les légumes rôtis tiennent quatre jours. Le riz cuit, trois jours maximum. La quiche se garde trois jours et peut même se manger froide. Pour le vendredi, on cuit les pâtes carbonara fraîches du jour, c'est l'un des rares plats qui demande une finition rapide en cuisine.

Petit conseil d'organisation : on étiquette chaque contenant avec la date et le contenu. Cela évite les jeux de devinette le mercredi soir, et permet de prioriser ce qui se mange en premier. On range aussi par ordre chronologique dans le frigo, pour avoir la quiche en avant le lundi matin.
