...
subthemes:
  - title: "Mijotés réchauffables"
    image: "images/recettes/chili-con-carne.jpg"
    intro: "Les plats en sauce qui gagnent en saveur au repos et se réchauffent à la perfection sur trois ou quatre jours."
    recipes:
      - { title: "Chili con carne", url: "/recettes/chili-con-carne/", desc: "le plat unique copieux à préparer en grande cocotte, encore meilleur le lendemain." }
      - { title: "Bœuf bourguignon", url: "/recettes/boeuf-bourguignon/", desc: "le mijoté français traditionnel, à préparer la veille pour gagner en intensité." }
      - { title: "Curry de poulet au lait de coco", url: "/recettes/curry-poulet/", desc: "un curry doux qui se conserve trois jours au frais et se réchauffe sans perdre en saveur." }
    cta_label: "Voir les mijotés à réchauffer"
    cta_url: "/recettes/batch-cooking/"
  - title: "Soupes et veloutés à congeler"
    image: "images/recettes/soupe-minestrone.jpg"
    intro: "Les soupes complètes qui supportent parfaitement la congélation en portions individuelles, à dégeler la veille au frigo."
    recipes:
      - { title: "Soupe minestrone", url: "/recettes/soupe-minestrone/", desc: "la soupe italienne complète aux légumes et aux pâtes, qui se congèle très bien sans les pâtes." }
      - { title: "Velouté de potiron", url: "/recettes/veloute-potiron/", desc: "à préparer en grand volume et à répartir en portions pour avoir des entrées toutes prêtes." }
      - { title: "Bouillon de poule maison", url: "", desc: "la base à congeler en bacs à glaçons, pour des soupes express toute l'année." }
    cta_label: "Toutes les soupes batch"
    cta_url: "/recettes/batch-cooking/"
  - title: "Bases et accompagnements prêts à assembler"
    image: "images/categories/batch-cooking.jpg"
    intro: "Les céréales, légumes rôtis et sauces qui se conservent plusieurs jours et s'assemblent rapidement en bowls ou en plats du soir."
    recipes:
      - { title: "Légumes rôtis au four", url: "", desc: "une plaque entière de légumes de saison, à intégrer dans des salades, gratins ou bowls de la semaine." }
      - { title: "Quinoa et boulgour cuits", url: "", desc: "à préparer en grande casserole, à conserver trois jours et à décliner en bowls ou en taboulé." }
      - { title: "Sauce tomate maison", url: "", desc: "la base à mettre en bocaux ou à congeler, pour des pâtes et pizzas express." }
    cta_label: "Découvrir les bases batch"
    cta_url: "/recettes/batch-cooking/"
faq:
  - q: "Combien de temps prévoir pour une session de batch cooking ?"
    a: "Comptez environ 2 à 3 heures pour préparer 4 à 5 repas de la semaine, en cuisinant plusieurs plats en parallèle. L'idéal est de planifier sa session le dimanche après-midi, avec une liste de courses faite la veille."
  - q: "Comment conserver les plats préparés à l'avance ?"
    a: "Au frigo pour 3 à 4 jours maximum dans des contenants hermétiques en verre, ou au congélateur jusqu'à 3 mois pour des portions individuelles. On laisse refroidir complètement avant de stocker et on étiquette avec la date."
  - q: "Quels plats supportent le mieux le réchauffage ?"
    a: "Les plats mijotés (chili, blanquette, ragoûts), les soupes, les currys, les gratins, les lasagnes et les céréales cuites (riz, quinoa) sont parfaits. On évite par contre les fritures, les salades vertes et les viandes saignantes qui se dégradent au réchauffage."
