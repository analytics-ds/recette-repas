...
subthemes:
  - title: "Desserts au chocolat"
    ...
    intro: "Le chocolat sous toutes ses formes, pour les amateurs de saveurs intenses et de textures fondantes."
    recipes:
      - { title: "Mousse au chocolat", url: "/recettes/mousse-chocolat/", desc: "le grand classique aérien, à préparer la veille pour qu'elle soit parfaitement prise." }
      - { title: "Fondant au chocolat", url: "", desc: "le dessert intense avec son cœur coulant, prêt en moins de vingt minutes." }
      - { title: "Profiteroles au chocolat chaud", url: "", desc: "des choux croustillants garnis de glace vanille et nappés d'une sauce au chocolat fumante." }
    cta_label: "Tous les desserts au chocolat"
    cta_url: "/recettes/desserts/"
  - title: "Tartes et desserts aux fruits"
    image: "images/recettes/tarte-pommes.jpg"
    intro: "Les desserts qui suivent les saisons, avec des fruits frais pour des recettes naturellement gourmandes et plus légères."
    recipes:
      - { title: "Tarte aux pommes", url: "/recettes/tarte-pommes/", desc: "le grand classique français à la pâte croustillante et aux pommes fondantes caramélisées." }
      - { title: "Crumble aux fruits rouges", url: "", desc: "une recette express, idéale pour utiliser des fruits un peu trop mûrs." }
      - { title: "Clafoutis aux cerises", url: "", desc: "le dessert d'été par excellence, avec sa pâte tendre et ses cerises juteuses." }
    cta_label: "Voir les desserts aux fruits"
    cta_url: "/recettes/desserts/"
  - title: "Desserts faciles et rapides"
    image: "images/categories/desserts.jpg"
    intro: "Les recettes prêtes en moins de trente minutes ou à préparer la veille, pour ne plus jamais finir un repas sans dessert."
    recipes:
      - { title: "Tiramisu aux framboises", url: "", desc: "un dessert italien revisité avec des framboises fraîches, à préparer en quinze minutes." }
      - { title: "Mousse au chocolat", url: "/recettes/mousse-chocolat/", desc: "prête en dix minutes, à laisser prendre au frais pendant que vous cuisinez le reste." }
      - { title: "Salade de fruits frais", url: "", desc: "la touche finale légère et colorée, idéale après un repas copieux." }
    cta_label: "Tous les desserts express"
    cta_url: "/recettes/desserts/"
faq:
  - q: "Quel dessert servir après un repas copieux ?"
    a: "On termine plutôt sur quelque chose de léger et de frais : une salade de fruits, une mousse aérienne, un sorbet ou un fromage blanc aux fruits. On évite les desserts crémeux ou très riches qui pèseraient sur l'estomac."
  - q: "Peut-on préparer un dessert la veille ?"
    a: "La majorité des desserts gagnent même à reposer une nuit au frais : mousses, tiramisus, tartes, entremets prennent ainsi tout leur fondant. Seules les pâtisseries soufflées et certaines pâtes feuilletées se travaillent le jour même."
  - q: "Comment réussir une pâte à tarte maison ?"
    a: "Travaillez la pâte rapidement et le moins possible pour ne pas la rendre élastique. Une fois formée en boule, laissez-la reposer au frais 30 minutes avant de l'étaler. Une cuisson à blanc pendant 10 minutes garantit un fond bien sec, surtout pour les tartes aux fruits juteux."
