...
subthemes:
  - title: "Plats mijotés traditionnels"
    image: "images/recettes/boeuf-bourguignon.jpg"
    intro: "Les classiques généreux qui demandent du temps mais récompensent la patience avec des saveurs profondes et une viande fondante."
    recipes:
      - { title: "Bœuf bourguignon", url: "/recettes/boeuf-bourguignon/", desc: "le mijoté français par excellence, viande fondante et sauce au vin rouge corsé." }
      - { title: "Hachis parmentier", url: "/recettes/hachis-parmentier/", desc: "le réconfort en cocotte avec sa purée gratinée au four." }
      - { title: "Soupe à l'oignon gratinée", url: "/recettes/soupe-oignon-gratinee/", desc: "un classique des bistrots, à servir bien chaud avec son croûton gratiné." }
    cta_label: "Voir tous les plats mijotés"
    cta_url: "/recettes/plats/"
  - title: "Plats rapides du quotidien"
    image: "images/recettes/carbonara.jpg"
    intro: "Les recettes prêtes en moins de trente minutes pour les soirs pressés, sans rien sacrifier au goût."
    recipes:
      - { title: "Pâtes à la carbonara à la française", url: "/recettes/pate-carbonara-francaise/", desc: "onctueuse et rapide, le secret tient dans la crème fraîche et les lardons fumés." }
      - { title: "Curry de poulet au lait de coco", url: "/recettes/curry-poulet/", desc: "parfumé et crémeux, prêt en trente minutes avec des ingrédients de base." }
      - { title: "Chili con carne", url: "/recettes/chili-con-carne/", desc: "un plat unique copieux qui se prépare en grande quantité et se réchauffe à merveille." }
    cta_label: "Voir les plats express"
    cta_url: "/recettes/plats/"
  - title: "Plats festifs et familiaux"
    image: "images/recettes/lasagnes-bolognaise.jpg"
    intro: "Les recettes qui rassemblent à table, pour les repas du dimanche et les grandes tablées conviviales."
    recipes:
      - { title: "Lasagnes à la bolognaise", url: "/recettes/lasagnes-bolognaise/", desc: "le grand classique italien qui plaît à toute la famille, à préparer la veille pour gagner du temps." }
      - { title: "Bœuf bourguignon", url: "/recettes/boeuf-bourguignon/", desc: "un grand plat de tradition, idéal pour un repas du dimanche ou de fête." }
      - { title: "Hachis parmentier", url: "/recettes/hachis-parmentier/", desc: "le plat familial réconfortant qui rassemble petits et grands autour de la même cocotte." }
    cta_label: "Découvrir les plats festifs"
    cta_url: "/recettes/plats/"
faq:
  - q: "Comment réussir un plat mijoté à tous les coups ?"
    a: "La règle d'or, c'est la patience et la cuisson à feu doux. Un plat mijoté gagne toujours à être préparé la veille : les saveurs se développent en reposant et la viande devient encore plus tendre à la seconde chauffe."
  - q: "Quel accompagnement servir avec un plat principal ?"
    a: "Pour un plat en sauce, on privilégie un féculent qui absorbe : pommes de terre, pâtes fraîches, polenta crémeuse ou un bon pain de campagne. Pour un plat sec comme une viande grillée, une salade verte ou des légumes rôtis suffisent."
  - q: "Peut-on préparer un plat à l'avance ?"
    a: "Les plats mijotés, gratins, lasagnes et plats en sauce se préparent très bien la veille et se réchauffent doucement à couvert. Les grillades et poissons se cuisinent par contre au dernier moment."
