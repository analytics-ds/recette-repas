...
weight: 4
description: "Des recettes venues d'ailleurs à refaire chez soi pour voyager le temps d'un repas."
subthemes_title: "La cuisine du monde par grandes régions"
subthemes_intro: "Des grands classiques italiens aux currys parfumés d'Asie du Sud-Est, en passant par les saveurs mexicaines et orientales, nos recettes vous font voyager sans quitter votre cuisine."
subthemes:
  - title: "Cuisine italienne"
    image: "images/recettes/lasagnes-bolognaise.jpg"
    intro: "Pâtes, gratins et plats généreux : la cuisine italienne reste celle qui rassemble le plus autour de la table."
    recipes:
      - { title: "Lasagnes à la bolognaise", url: "/recettes/lasagnes-bolognaise/", desc: "la version familiale avec sa sauce mijotée, sa béchamel et son gratiné de parmesan." }
      - { title: "Pâtes à la carbonara à la française", url: "/recettes/pate-carbonara-francaise/", desc: "la carbonara dans sa version crémeuse aux lardons, telle qu'on la connaît en France." }
      - { title: "Risotto aux champignons", url: "", desc: "le risotto crémeux et parfumé, à remuer doucement pour atteindre la texture parfaite." }
    cta_label: "Voir la cuisine italienne"
    cta_url: "/recettes/cuisine-monde/"
  - title: "Cuisine asiatique"
    image: "images/recettes/curry-poulet.jpg"
    intro: "Currys parfumés, plats sautés au wok et nouilles épicées : les saveurs d'Asie à reproduire à la maison avec des ingrédients accessibles."
    recipes:
      - { title: "Curry de poulet au lait de coco", url: "/recettes/curry-poulet/", desc: "un curry doux et crémeux, parfait pour une initiation aux épices asiatiques." }
      - { title: "Nouilles sautées au wok", url: "", desc: "un plat express qui se prépare en moins de quinze minutes, avec les légumes du frigo." }
      - { title: "Poulet teriyaki", url: "", desc: "la marinade sucrée-salée japonaise pour des morceaux de poulet laqués à la poêle." }
    cta_label: "Découvrir la cuisine asiatique"
    cta_url: "/recettes/cuisine-monde/"
  - title: "Cuisine latine et orientale"
    image: "images/categories/cuisine-monde.jpg"
    intro: "Du chili con carne mexicain aux saveurs orientales du Maghreb, des recettes pleines de soleil pour épicer les repas."
    recipes:
      - { title: "Chili con carne", url: "/recettes/chili-con-carne/", desc: "un grand plat tex-mex copieux, à préparer en grande quantité pour la semaine." }
      - { title: "Tajine de poulet aux olives", url: "", desc: "le plat marocain mijoté lentement, parfumé au citron confit et aux olives vertes." }
      - { title: "Couscous traditionnel", url: "", desc: "la semoule, le bouillon de légumes et la viande, dans la grande tradition du Maghreb." }
    cta_label: "Voir les saveurs latines et orientales"
    cta_url: "/recettes/cuisine-monde/"
faq:
  - q: "Où trouver les ingrédients d'une recette exotique ?"
    a: "La plupart des produits de base (sauce soja, curry, lait de coco, épices courantes) se trouvent en grande surface. Pour les ingrédients plus pointus, direction les épiceries asiatiques, indiennes ou orientales des grandes villes, ou les sites spécialisés en ligne."
  - q: "Peut-on adapter une recette étrangère avec des produits locaux ?"
    a: "Souvent oui, à condition de préserver ce qui fait l'identité du plat. On peut remplacer un poisson asiatique par un poisson local, mais on garde les épices et la technique de cuisson, qui sont la vraie signature de la recette."
  - q: "Quelles épices avoir absolument dans son placard ?"
    a: "Un kit de départ raisonnable : cumin, coriandre moulue, paprika fumé, curcuma, gingembre, curry, garam masala, ras-el-hanout et piment doux. Avec ça, on couvre la cuisine indienne, maghrébine, mexicaine et une bonne partie de l'Asie."
